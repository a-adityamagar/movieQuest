...
function App() {
  ...
  return (
    <div className="min-h-screen bg-gray-900 text-white">
      <header className=" shadow-lg  top-0 z-40">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 sm:py-6">
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
            <div className="flex items-center space-x-4">
              <Film className="w-8 h-8 text-white" />
              <h1 className="text-xl sm:text-2xl font-bold">MovieQuest</h1>
            </div>
            <div className="flex-grow max-w-2xl">
              <div className="relative">
                <input
                  ...
                  className="w-full px-4 py-2 bg-gray-700 rounded-lg focus:outline-none focus:ring-2 focus:ring-white pl-10"
                />
        ...
        {!isSearching && (
          <div className="mb-8">
            <div className="flex items-center space-x-2 mb-4">
              <Tag className="w-5 h-5 text-white-500" />
